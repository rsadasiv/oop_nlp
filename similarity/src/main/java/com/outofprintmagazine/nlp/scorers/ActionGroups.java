...
public class ActionGroups extends PosLexicalGroupScorerImpl implements DocumentCategoricalScorer, SentenceDescriptiveScorer {
...
//		}
		...
		public ActionGroups(Ta ta) throws IOException {
			this(ta, Arrays.asList("VB","VBD","VBG","VBN","VBP","VBZ"));
		}
		
		public ActionGroups(Ta ta, List<String> tags) throws IOException {
			super(ta, tags);
		}	
